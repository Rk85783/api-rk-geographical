...
const reviewSchema = new Schema(
  {
    ...
    "What type(s) of freight did you ship?": [{ type: Number, required: true }],
    "What type(s) of truck did you use?": [{ type: Number, required: true }],
    "What type(s) of shipments did this carrier take?": [{ type: Number, required: true }],
    "What specialized services did this carrier provide?": [[{ type: Number }]],
    "Did this carrier use electronic tracking?": { type: Boolean, required: true },
    "Add a verification screenshot": { type: String },
